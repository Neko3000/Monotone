...
class HelpCollectionViewCell: UICollectionViewCell {
    ...
    private func buildSubviews(){
        ...
        self.titleLabel.text = "Managing your Unsplash Account"
        ...
        self.descriptionLabel.text = "Learn about your Unsplash account and how to manage your preferences"
        ...
        self.countLabel.text = "14 articles in this collection"
    ...
    private func buildLogic(){
        ...
        self.category
            ...
            .subscribe(onNext: { [weak self] (category) in
                ...
                self.countLabel.text = "\(category.count)"
